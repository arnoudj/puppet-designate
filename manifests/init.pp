...
class designate(
  ...
  if $rabbit_use_ssl {
    ...
    if $kombu_ssl_ca_certs {
      designate_config { 'oslo_messaging_rabbit/kombu_ssl_ca_certs': value => $kombu_ssl_ca_certs; }
    } else {
      designate_config { 'oslo_messaging_rabbit/kombu_ssl_ca_certs': ensure => absent; }
    }
    ...
    if $kombu_ssl_version {
      designate_config { 'oslo_messaging_rabbit/kombu_ssl_version':  value => $kombu_ssl_version; }
    } else {
      designate_config { 'oslo_messaging_rabbit/kombu_ssl_version':  ensure => absent; }
    }
